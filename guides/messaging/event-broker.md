...
::: tip Local Testing
Since SAP Event Broker sends events via HTTP, you won't be able to receive events on your local machine unless you use a tunneling service. It's recommended to use `local-messaging` for local testing.
:::
